    ...
    return (
        <section className="bg-white dark:bg-gray-500 w-sidebar_width fixed right-0 top-0 h-screen pt-navbar_height overflow-y-auto shadow-lg">
            <div className="w-full p-4">
                <ul>
                    {items.map((item , i)=>(
                        <li key={"sidebarItems"+i} className="my-4 cursor-pointer dark:hover:bg-gray-500 dark:hover:bg-slate-700 dark:hover:text-slate-50 hover:bg-blue-100 border border-blue-600 dark:border-white text-blue-600 dark:text-white rounded-md">
